...
2. Run ```requirements.bat``` or ```$ bash requirements.sh``` depending on your operating system
...
<br>
8. Open a terminal in the same directory and run ```$ bash start.sh``` or ```start.bat```
<br>
9. Have fun :3

# Tested on:
Windows 11 25HZ with Bash,Command Prompt,Powershell using python3.14.4
